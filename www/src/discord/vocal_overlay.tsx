...
export default function VocalOverlay() {
  const [users, setUsers] = useState<DiscordUser[]>([
    {
      ...
      speaking: false,
      avatar:
        "https://cdn.discordapp.com/attachments/455866738198970409/1053964076499353600/avatar_user1_silent.png",
    },
    {
      id: "5678",
      username: "ChatterBox",
  ...
  const [defaultAvatarSpeaking, setDefaultAvatarSpeaking] =
    useState<string>("");
  ...
  function compileStyle() {
    ...
    if (size.width === "auto" || size.width > 0) {
      ...
      avatar["width"] =
        (size.width === "auto" ? "auto" : `${size.width}px`) + " !important";
  ...
  return (
    <div className="">
      ...
      <h2>Preview</h2>
      <p>
        Ordered alphabetically just like on Discord, click the user to make them
        "speak".
      </p>
